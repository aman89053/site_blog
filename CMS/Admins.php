...
if(isset($_POST["Submit"])){
    ...
    if(empty($Username)||empty($role)||empty($Password)||empty($ConfirmPassword)){
    ...
    elseif(CheckUsernameExists($Username)){
        ...
        $sql="INSERT INTO admins(datetime,username,password,aname,addedby,rolename)
                VALUES(:dateTime,:userName,:passWord,:aName,:addedBy,:roleName)";
    ...
    <nav class="navbar navbar-expand-lg navbar-dark text-dark bg-dark">
        <div class="container">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a href="Admins.php" class="nav-link">Manage Users and Admins</a>
                </li>
                <li class="nav-item">
                ...
                <div class="card-header bg-dark text-secondary ">
                    ...
                    <div class="card-body bg-dark">
                        ...
                        <label for="role"><span class="Fieldinfo">Role:</span></label>
                            ...
                            <small class="text-warning text-muted">Required</small>
                        </div>
                        <div class="form-group">
            ...
            <h2>Existing Admins</h2>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><?php echo htmlentities($AdminRole); ?></td>
