...
if(isset($_POST["Submit"])){
   ...
   if(strlen($AHeadline)>30){
    ...
    elseif(strlen($ABio)>300){
        $_SESSION["ErrorMessage"]="Bio must be less than 300 characters";
        Redirect_to("MyProfile.php");
    }else{
        global $ConnectingDB;
...
<body>
    ...
    <section class="container">
        ...
        <h3><?php  $ExistingName; echo $ExistingName; ?></h3>
        </div>
        <div class="card-header bg-info text-light">
        <h5><?php  $ExistingHeadline; echo $ExistingHeadline; ?></h5>
        </div>
        <div class="card-body">
        <img src="Images/<?php $ExistingImage; echo $ExistingImage; ?>" height="250px" width="200px" alt="">
        <div>
