...
if(isset($_POST["Submit"])){
    ...
    elseif(strlen($PostTitle)<5){
        $_SESSION["ErrorMessage"]="Post title must be greater than five characters";
        Redirect_to("Posts.php");
    }
    elseif(strlen($PostText)>9999){
        $_SESSION["ErrorMessage"]="Post Description must be less than ten thousand characters";
        Redirect_to("Posts.php");
    }else{
        global $ConnectingDB;
        ...
        if(empty($_FILES["Image"]["name"])){
            if(empty($_POST["Category"])){
                $sql="UPDATE posts
                    SET title='$PostTitle',image='$Image',post='$PostText'
            ...
            <div class="card">
                    <div class="card-body bg-dark">
                        ...
                        <div class="form-group">
                            ...
                            <span class="text-light"><?php echo $CategoryToBeUpdated; ?></span><br/>
                        ...
                        <div class="form-group">
                            ...
                            <img src="Uploads/<?php echo $ImageToBeUpdated; ?>" width="170px;" height="70px;" class="mb-1">
