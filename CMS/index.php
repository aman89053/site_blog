  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="container">
      <div class="row mt-4">
        ...
        <div class="col-sm-8 ">
          <h1>The Blog</h1>
          <h1 class="lead">The Complete blog by using PHP by amanagrawal</h1>
          <?php
           echo ErrorMessage();
           echo SuccessMessage();
           ?>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <span style="float:right;" class="badge badge-dark text-light">Comments:
                 <?php echo ApprCommentsRegPosts($PostId);?>
              </span>
              <hr>
              <p class="card-text">
                <?php if (strlen($PostDescription)>300) { $PostDescription = substr($PostDescription,0,300)."...";} echo htmlentities($PostDescription); ?></p>
        ...
        <div class="col-sm-4">
          <div class="card mt-4">
            <div class="card-body">
              <img src="./Images/comment.jpg" class="d-block img-fluid mb-3" alt="">
...
<br>
    ...
    <footer class="bg-dark text-white">
      <div class="container">
        <div class="row">
          <div class="col">
          <p class="lead text-center">Made By | Aman Agrawal | <span id="year"></span> &copy; ----All right Reserved.</p>
           </div>
         </div>
      </div>
    </footer>
